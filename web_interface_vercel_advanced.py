...
<html lang="fr">
    ...
    <script>
        ...
        function showExecutionStatus(automationId) {
            ...
            // Masquer l'indicateur après 5 secondes (temps d'exécution estimé)
            setTimeout(function() {
                if (statusDiv) {
...
def run_automation(automation_id):
    ...
    try:
        ...
        if automation_id == 'sync_aircall':
            # Exécuter la synchronisation Aircall
            ...
            # Exécuter la création de tâches
            ...
            # Exécuter la liaison des contacts
...
def execute_aircall_sync():
    ...
    try:
        ...
        try:
            ...
            add_log("⚠️ Modules d'automatisation non trouvés, simulation...")
            return {"success": True, "message": "Simulation - Modules non disponibles"}
        ...
        for call in calls[:5]:  # Limiter à 5 appels pour éviter les timeouts
            try:
                ...
                if str(call['id']) not in existing_ids:
                    ...
                    synced_count += 1
                    add_log(f"✅ Appel {call['id']} synchronisé")
            ...
            try:
                ...
                if actions_ia and actions_ia.strip().lower() != 'non disponible':
                    ...
                    for action in parsed_actions:
                        ...
                        if task_id:
                            tasks_created += 1
                            add_log(f"✅ Tâche créée: {task_name}")
